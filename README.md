...
- Authentication and authorization groups in the Django administration: Supervisors: View all apps database Managers: Change and view all apps database Moderators: Add, Change, Delete, and View all apps database
...
| Color | Hex |
| --------------- | ---------------------------------------------------------------- |
| Primary Color | ![#09244c](https://via.placeholder.com/10/09244c?text=+) #09244c |
